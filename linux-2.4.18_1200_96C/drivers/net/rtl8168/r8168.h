...
//#define CONFIG_R8168_NAPI 1 //michael
...
#define RTL8168_VERSION "8.006.00" NAPI_SUFFIX
...
struct rtl8168_private {
	...
	int loopback_tx_schedule;
	int loopback_state;
	int loopback_type;
	struct tasklet_struct loopback_tasklet;
	struct sk_buff *loopback_skb;
	int loopback_tx_ok;
	int loopback_rx_ok;
	int loopback_tx_err;
	int loopback_rx_err;
	unsigned char *loopback_pkt_payload;
	int loopback_pkt_payload_len;
