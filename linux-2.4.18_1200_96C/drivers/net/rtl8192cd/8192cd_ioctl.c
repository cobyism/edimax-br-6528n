 ...
 *
 *  $Id: 8192cd_ioctl.c,v 1.36.2.17 2011/03/21 07:31:13 jimmylin Exp $
 *
...
#else
#if defined(CONFIG_RTL8196B_GW_8M) || defined(CONFIG_RTL8196C_AP_ROOT) || defined(CONFIG_RTL8198_AP_ROOT) || defined(CONFIG_RTL8196C_CLIENT_ONLY) || defined(__ECOS)
...
int rtl8192cd_getAutoChannel(char *wlan_ifname, int *channel)
{
	...
	*channel = priv->pmib->dot11RFEntry.dot11channel;
    ...
    return priv->pmib->dot11nConfigEntry.dot11n2ndChOffset;
}
