...
#else
	struct rtl_pool		*qh_pool;	/* qh per active urb */
	struct rtl_pool		*qtd_pool;	/* one or more per qh */
	struct rtl_pool		*itd_pool;	/* itd per iso urb */
	struct rtl_pool		*sitd_pool;	/* sitd per split iso urb */
#endif
