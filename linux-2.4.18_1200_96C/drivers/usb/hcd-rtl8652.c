...
char _rtl865x_onChip_usb_busName[] = _RTL865X_ONCHIP_USB_BUSNAME;
char _rtl865x_onChip_usb_description[] = _RTL865X_ONCHIP_USB_DESCRIPTION;
...
// (fixed in 2.5)
	...
	/* We init a default bus-Name and description for driver, or system would crash if debugging message is turned ON. */
	bus->bus_name = _rtl865x_onChip_usb_busName;
	hcd->product_desc = _rtl865x_onChip_usb_description;
