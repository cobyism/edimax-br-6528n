...
/* 
 * Important to place the macro declaration here, due to a binutils bug (as)
 * which produces bad addresses, when getting the address of a struct member
 * for initializing the same struct, and when there is data or static 
