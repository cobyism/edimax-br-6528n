...
#PWD := $(shell /bin/pwd)
#ifneq "$(findstring $(TOPDIR)/rtkload, $(PWD))" ""
...
%.o16: %.c
	#$(CC) $(CFLAGS) $(EXTRA_CFLAGS) $(EXTRA_MIPS16) -DKBUILD_BASENAME=$(subst $(comma),_,$(subst -,_,$(*F))) $(CFLAGS_$@) -S $< -o $@.s 
	$(CC) $(CFLAGS) $(EXTRA_CFLAGS) $(EXTRA_MIPS16) -DKBUILD_BASENAME=$(subst $(comma),_,$(subst -,_,$(*F))) $(CFLAGS_$@) -c -o $@ $<
	@ ( \
...
%.o16: %.S
	$(CC) $(AFLAGS) $(EXTRA_CFLAGS) $(EXTRA_MIPS16) $(AFLAGS_$@) -c -o $@ $<
...
#LD=/toolchain/rsdk-1.2.11/linux/mips-linux-ld
#CC=/toolchain/rsdk-1.2.11/linux/mips-linux-gcc
#CPP=/toolchain/rsdk-1.2.11/linux/mips-linux-gcc
#STRIP=/toolchain/rsdk-1.2.11/linux/mips-linux-strip
#AS=/toolchain/rsdk-1.2.11/linux/mips-linux-as
#NM = /toolchain/rsdk-1.2.11/linux/mips-linux-nm
#OBJCOPY=/toolchain/rsdk-1.2.11/linux/mips-linux-objcopy
#else
#ifeq ($(USE_RSDK_96C),1)
#LD=/toolchain/rsdk-96c/linux/mips-linux-ld
#CC=/toolchain/rsdk-96c/linux/mips-linux-gcc -march=4181
#CPP=/toolchain/rsdk-96c/linux/mips-linux-gcc
#STRIP=/toolchain/rsdk-96c/linux/mips-linux-strip
#AS=/toolchain/rsdk-96c/linux/mips-linux-as
#NM = /toolchain/rsdk-96c/linux/mips-linux-nm
#OBJCOPY=/toolchain/rsdk-96c/linux/mips-linux-objcopy
#STRIP=/toolchain/rsdk-96c/linux/mips-linux-strip
#else
#LD=/toolchain/rsdk/linux/mips-linux-ld
#CC=/toolchain/rsdk/linux/mips-linux-gcc -march=5181
#CPP=/toolchain/rsdk/linux/mips-linux-gcc
#STRIP=/toolchain/rsdk/linux/mips-linux-strip
#AS=/toolchain/rsdk/linux/mips-linux-as
#NM = /toolchain/rsdk/linux/mips-linux-nm
#OBJCOPY=/toolchain/rsdk/linux/mips-linux-objcopy
#STRIP=/toolchain/rsdk/linux/mips-linux-strip
#endif
#endif
CROSS_COMPILE=/home/RTL8196C/toolchain/rtl8196c-toolchain-1.1/rsdk-96c/bin/rsdk-linux-
AS              = $(CROSS_COMPILE)as
LD              = $(CROSS_COMPILE)ld
...
ifdef CONFIG_RTL_KERNEL_MIPS16
	echo $(obj-y) >.objlist
	$(TOPDIR)/scripts/mkdep -mips16 .objlist $(CFLAGS) $(EXTRA_CFLAGS) -- $(wildcard *.[chS]) > .depend
	rm -f .objlist
else
