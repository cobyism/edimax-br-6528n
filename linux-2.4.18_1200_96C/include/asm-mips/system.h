...
extern void __sti__(void);
extern void __cli__(void);
extern void __save_flags__(unsigned long *x);
extern void __save_and_cli__(unsigned long *x);
extern void __restore_flags__(unsigned long x);

#  define sti() __sti__()
#  define cli() __cli__()
#  define save_flags(x) __save_flags__((unsigned long *)&x)
#  define save_and_cli(x) __save_and_cli__((unsigned long *)&x)
#  define restore_flags(x) __restore_flags__((unsigned long)x)
#else
#  define sti() __sti()
#  define cli() __cli()
...
/* For spinlocks etc */
#ifdef CONFIG_RTL_KERNEL_MIPS16
#define local_irq_save(x)	__save_and_cli__((unsigned long *)&x)
#define local_irq_restore(x)	__restore_flags__((unsigned long)x)
#define local_irq_disable()	__cli__()
#define local_irq_enable()	__sti__()
#else
