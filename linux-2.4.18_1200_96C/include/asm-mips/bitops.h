...
#define __bi_cli() __cli__()
#define __bi_save_flags(x) __save_flags__((unsigned long *)&x)
#define __bi_save_and_cli(x) __save_and_cli__((unsigned long *)&x)
#define __bi_restore_flags(x) __restore_flags__((unsigned long)x)
#else 
