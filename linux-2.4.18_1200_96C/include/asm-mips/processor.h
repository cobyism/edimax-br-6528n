...
#define KERNEL_STACK_SIZE CONFIG_STACK_SIZE//8192
 ...
 */
#define THREAD_SIZE CONFIG_STACK_SIZE//(2*PAGE_SIZE)
#define STACK_SIZE_NUMBER (CONFIG_STACK_SIZE/(2*PAGE_SIZE))
#define alloc_task_struct() \
	((struct task_struct *) __get_free_pages(GFP_KERNEL,STACK_SIZE_NUMBER))
#define free_task_struct(p)	free_pages((unsigned long)(p),STACK_SIZE_NUMBER)
