...
// for RTL IPSec
#include "../../net/ipsec/rtl8186_crypto_if.h"
...
// for RTL IPSec
	struct rtl8186_crypto_request req;

#ifdef CONFIG_RTK_VOIP_VLAN_ID
	// Record skb is received from which net_if.
	// 0 denotes generated by local host.
	// Must be reset to 0 in alloc_skb().
	unsigned int rx_vlan;
	unsigned int rx_wlan;
#endif	
...
#define RTK_VLAN_ROUTETYPE_PASS_SRC_INFO
#endif
...
// for RTL IPSec
	...
	skb = alloc_skb(length+128, gfp_mask);
	if (skb)
		skb_reserve(skb,128);
