...
//#define __exit		__attribute__ (( __section__(".text.exit")))
#define __exit		__attribute_used__ __attribute__ (( __section__(".text.exit")))
#define __initdata	__attribute__ ((__section__ (".data.init")))
//#define __exitdata	__attribute__ (( __section__ (".data.exit")))
//#define __initsetup	__attribute__ (( __section__ (".setup.init")))
