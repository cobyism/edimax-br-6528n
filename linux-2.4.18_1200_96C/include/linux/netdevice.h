...
#define SUPPORT_INPUT_PKT_QUEUE_VOIP
#endif
...
static inline int netif_queue_stopped(struct net_device *dev)
{
	...
	return ((1UL << (__LINK_STATE_XOFF & 31)) & (((const unsigned int *) &dev->state)[__LINK_STATE_XOFF >> 5])) != 0;
#else
...
{
#ifdef GCCPATCH_1_3_X
	return ((1UL << (__LINK_STATE_START & 31)) & (((const unsigned int *) &dev->state)[__LINK_STATE_START >> 5])) != 0;
#else
