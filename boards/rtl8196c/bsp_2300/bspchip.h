...
#define BSP_NFBI_RS         BSP_IRQ_CASCADE
#define BSP_GPIO_EFGH_RS    (15)
#define BSP_GPIO_ABCD_RS    (14)
#define BSP_SW_RS           4
...
#define BSP_IRR1_SETTING    ((BSP_SW_RS    << 0) | \
                         (BSP_TC0_RS  << 24) | \
                         (BSP_UART1_RS << 20) | \
                         (BSP_OCPTMO_RS << 16) | \
                         (BSP_GDMA_RS << 12) | \
