...
#define BSP_TC0_IRQ             (BSP_IRQ_LOPI_BASE + 5)
...
#define BSP_PCIE_IRQ            (BSP_IRQ_LOPI_BASE + 2)  // shall be 22
#define BSP_PCIE2_IRQ           (BSP_IRQ_LOPI_BASE + 3)
