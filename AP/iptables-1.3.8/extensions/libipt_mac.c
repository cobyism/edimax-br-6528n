      ...
      struct ipt_entry_match **match)
{
	...
	case '1':
		...
		#ifndef _KERNEL_VERSION_26_		//EDX
		if (invert)
			macinfo->invert = 1;
		#endif					//EDX
		*flags = 1;
...
//EDX	if (((struct ipt_mac_info *)match->data)->invert)
//EDX		printf("! ");

	#ifdef _KERNEL_VERSION_26_	// EDX
	print_mac(((struct ipt_mac_info *)match->data)->srcaddr.macaddr);
	#else
	if (((struct ipt_mac_info *)match->data)->invert)	//EDX
		printf("! ");					//EDX
