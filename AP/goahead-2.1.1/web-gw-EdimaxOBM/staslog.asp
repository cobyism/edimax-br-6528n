...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
	<!-- top menu -->
	<script>Write_Header(4,4)</script>
	<!-- middle menu -->
	<tr>
		<td>
			<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td colspan="3" valign="top" align="center"><br>
									<form method="post" action="goform/formSecLog" name="secLog">
										<textarea cols="75" name="logtext" readOnly rows="9" wrap="off" edit="off" style="color:Navy"><% getInfo("seclog"); %></textarea>
										<p align="center">
									...
									<table width="360"  height="400 "border="0" cellpadding="5" cellspacing="0" bgcolor="#999999">
										...
										<tr>
											<td height="384" valign="top" bgcolor="#999999">
												<span class="style1">
													<span class="style13"><script>dw(statSecurity)</script></span><br />
													<span class="style21"><script>dw(statSecurityDoc)</script></span>
												</span>
											</td>
										</tr>
									</table>
