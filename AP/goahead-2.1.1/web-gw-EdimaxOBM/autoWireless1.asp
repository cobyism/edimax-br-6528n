		...
		<td width="750" align="center" valign="top" bgcolor="#EFEFEF">
			...
			<table border="0" cellspacing="3" cellpadding="0" width="480" align="left">
				<tr valign="middle" align="left" height="40">
					<td width="36">
						<input type="radio" name="autoWireless" value="0" onClick="saveChanges()" onmouseover="mouseover()" onmouseout="mouseout()" style="cursor:pointer">
					</td>
					<script>
						if (secModeTbl == 0)
							document.write('<td width="400"><a class="stringcolor" onmouseover="mouseover()" onmouseout="mouseout()" style="cursor:pointer" onClick="saveChanges()"><b>'+showText(Yes1)+'</b></a></td>')
						else
							document.write('<td width="400"><a class="stringcolor" onmouseover="mouseover()" onmouseout="mouseout()" style="cursor:pointer" onClick="saveChanges()"><b>'+showText(Yes2)+'</b>&nbsp;<img src="graphics/img_check.gif"></a></td>')
					</script>
				</tr>
				<tr valign="middle" align="left" height="40">
					<td width="36">
						<input type="radio" name="autoWireless" value="1" onClick="saveChanges()" onmouseover="mouseover1()" onmouseout="mouseout1()" style="cursor:pointer">
					</td>
					<td width="400"><a class="stringcolor" onmouseover="mouseover1()" onmouseout="mouseout1()" style="cursor:pointer" onClick="saveChanges()"><b><script>dw(Askme)</script></b></a></td>
				</tr>
				<tr valign="middle" align="left" height="40">
					<td width="36">
						<input type="radio" name="autoWireless" value="2" onClick="saveChanges()" onmouseover="mouseover2()" onmouseout="mouseout2()" style="cursor:pointer">
					</td>
					<td width="400"><a class="stringcolor" onmouseover="mouseover2()" onmouseout="mouseout2()" style="cursor:pointer" onClick="saveChanges()"><b><script>dw(Nodonot)</script></b></a></td>
				</tr>
			</table>
			</blockquote>
		</td>
